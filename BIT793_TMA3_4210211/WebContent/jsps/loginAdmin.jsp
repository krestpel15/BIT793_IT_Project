...
<body>
	...
	<form id="LoginAdmin" method="post" autocomplete="off"
		action="${pageContext.request.contextPath}/StatcoverServlets.LoginCheck_admin">

		<fieldset class="field-set">
			<legend>Admin Login Details</legend>

			<div class="field-group">
				<!-- Email should not be empty -->
				<label for="email">Admin Email:</label> <input type="text"
