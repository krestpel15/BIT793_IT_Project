...
<body>
	...
	<form id="LoginDm" method="post" autocomplete="off"
		action="${pageContext.request.contextPath}/StatcoverServlets.LoginCheck_dm">

		<fieldset class="field-set">
			<legend>Duty Manager Login Details</legend>
