...
<body>
	...
	%>
	<h2 align="center">
		<font><strong>Request Notifications from STATCover</strong></font>
	</h2>
	...
	<form name="tables" method="post">
		<table class="table table-striped table-dark">
			...
			<tr>
				<th><b>Request Message Id</b></th>
				<th><b>Requesting DM Id</b></th>
				<th><b>Request Message</b></th>
			...
			<%
				try {
					...
					String query1 = "SELECT * FROM statcover_request_notification";
			...
			<tr>
				<td><%=rs.getInt("reqMessage_id")%></td>
				<td><%=rs.getString("req_dm_id")%></td>
				<td><%=rs.getString("req_message")%></td>
