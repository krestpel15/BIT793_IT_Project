...
<body>
	...
	%>
	<h2 align="center">
		<font><strong>Confirmed Requests from STATCover</strong></font>
	</h2>
	...
	<form name="tables" method="post">
		<table class="table table-striped table-dark">
			...
			<tr>
				<th><b>Confirmed Id</b></th>
				<th><b>Request Id</b></th>
				<th><b>Duty Manager Id</b></th>
				<th><b>Staff Id</b></th>
			</tr>
			...
			<%
				try {
					...
					String query1 = "SELECT * FROM statcover_confirmed_requests";
			...
			<tr>
				<td><%=rs.getInt("confirmed_id")%></td>
				<td><%=rs.getString("requestid")%></td>
				<td><%=rs.getString("dmid")%></td>
